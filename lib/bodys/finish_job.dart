...
class _FinishJobState extends State<FinishJob> {
  ...
  Future<void> readData() async {
    String path =
        'https://www.androidthai.in.th/egat/getUserWhereidofficerSuccess_toy1.php?isAdd=true&idOfficer=${widget.idOfficer}';
                      ...
                      child: Column(
                        children: [
                          SizedBox(
                              ...
                              height: 75,
                              child: Image.network(
                                jobmodel[index].pathImage,
                              )),
                          ShowText(text: jobmodel[index].job),
                        ],
                      ),
                    ))
            : const Center(
